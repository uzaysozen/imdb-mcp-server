...
def register_tools(mcp):
    ...
    async def search_imdb(
        ...
        original_title_autocomplete: Optional[str],
        primary_title: Optional[str],
        primary_title_autocomplete: Optional[str],
        type: Optional[str],
        genre: Optional[str],
        genres: Optional[List[str]],
        is_adult: Optional[bool],
        average_rating_from: Optional[float],
        average_rating_to: Optional[float],
        num_votes_from: Optional[int],
        num_votes_to: Optional[int],
        start_year_from: Optional[int],
        start_year_to: Optional[int],
        countries_of_origin: Optional[List[str]],
        spoken_languages: Optional[List[str]],
        sort_order: Optional[Literal["ASC", "DESC"]],
        sort_field: Optional[Literal["id", "averageRating", "numVotes", "startYear"]],
        ) -> str:
